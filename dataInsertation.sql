select a.albumTitle, a.albumPlaytime, a.albumReleaseDate, a.albumGenre, a.albumPrice, a.albumTracks, artists.*, reviews.*, 
treat(value(a) as disk_type).mediaType as mediaType
from albums a, table(a.albumArtists) artists, table(a.albumReviews) reviews where value(a) is of (disk_type)
union all
select b.albumTitle, b.albumPlaytime, b.albumReleaseDate, b.albumGenre, b.albumPrice, b.albumTracks, artists.*, reviews.*, 'mp3'
from albums b, table(b.albumArtists) artists, table(b.albumReviews) reviews where value(b) is of (mp3_type)

---insert data---
-----------------
insert into albums values(
    disk_type(
    'The Essential Bob Dylan',99,'8-Jul-2016','Pop',37,32,
    artist_array_type(
...
insert into albums values(
    disk_type(
    'Sketches of Spain',45,'8-Mar-2011','Jazz',14.99,6,
    artist_array_type(
...
insert into albums values(
    disk_type(
    'Bob Dylan''s Greatest Hits',45,'31-Jan-2017','Pop Rock',29.87,10,
    artist_array_type(
    artist_type('Bob Dylan', 'Composer'),
    artist_type('Bob Dylan', 'Vocals')
    ),
...
insert into albums values(
    disk_type(
    'Harvest (2009 Remaster)',44,'21-Jun-2009','Rock Country',28.50,10,
    artist_array_type(
...
insert into albums values(
    disk_type(
    'Kind Of Blue (Legacy Edition)',155,'20-Jan-2009','Jazz',19.99,21,
    artist_array_type(
    artist_type('Miles Davis', 'Composer'),
    artist_type('Miles Davis', 'Musician')
    ),
...
insert into albums values(
    disk_type(
    'Harvest (2009 Remaster)',44,'21-Jun-2009','Rock Country',10.50,10,
    artist_array_type(
    artist_type('Neil Young', 'Composer'),
    artist_type('Neil Young', 'Vocals')
    ),
...
insert into albums values(
    disk_type(
    'The Essential Bob Dylan',99,'8-Jul-2016','Pop',26.17,32,
    artist_array_type(
    artist_type('Bob Dylan', 'Composer'),
    artist_type('Bob Dylan', 'Vocals')
    ),
...
insert into albums values(
    disk_type(
    'Bob Dylan''s Greatest Hits',55,'1-Jun-1999','Pop Rock',20.81,10,
    artist_array_type(
    artist_type('Bob Dylan', 'Composer'),
    artist_type('Bob Dylan', 'Vocals')
    ),
...
insert into albums values(
    disk_type(
    'Sketches of Spain',45,'20-Jan-2009','Jazz',3.11,6,
    artist_array_type(
    artist_type('Miles Davis', 'Composer'),
    artist_type('Miles Davis', 'Musician')
    ),
...
insert into albums values(
    disk_type(
    'Gustav Mahler Symphony No.9',45,'12-Oct-2017','Classical',23.10,5,
    artist_array_type(
...
insert into albums values(
    mp3_type(
    'Bob Dylan''s Greatest Hits',55,'1-Jan-2019','Pop Rock',5.98,10,
    artist_array_type(
    artist_type('Bob Dylan','Composer'),
    artist_type('Bob Dylan','Vocals')
    ),
...
insert into albums values(
    mp3_type(
    'Best of Neil Young',153,'21-Feb-2019','Pop Rock',17.50,35,
    artist_array_type(
    artist_type('Neil Young','Composer'),
    artist_type('Neil Young','Vocals')
    ),
...
insert into albums values(
    mp3_type(
    'Harvest (2009 Remaster)',44,'21-Jun-2009','Rock Country',9.49,10,
    artist_array_type(
    artist_type('Neil Young','Composer'),
    artist_type('Neil Young','Vocals')
    ),
...
insert into albums values(
    mp3_type(
    'Sketches of Spain',45,'16-Aug-2013','Jazz',24.99,6,
    artist_array_type(
    artist_type('Miles Davis','Composer'),
    artist_type('Miles Davis','Musician')
    ),
...
insert into albums values(
    mp3_type(
    'B.B. King Greatest Hits',114,'16-Jul-2013','Rock Blues',11.49,24,
    artist_array_type(
...
insert into albums values(
    mp3_type(
    'The Essential Bob Dylan',99,'8-Jul-2016','Pop',16,32,
    artist_array_type(
    artist_type('Bob Dylan','Composer'),
    artist_type('Bob Dylan','Vocals')
    ),
...
insert into albums values(
    mp3_type(
    'Other People Lives',42,'15-Feb-2019','Rock Dance',9.49,10,
    artist_array_type(
    artist_type('Stats','Composer'),
    artist_type('Stats','Vocals')
    ),
    review_table_type(
    review_type('Georage', '17-Sep-2019', 'Good dancing music.', 3)
    ),
    45))
/